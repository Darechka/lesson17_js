...
//     arr.forEach (function (item) { // перебираем массив и каждый его элемент добавляем в set
//         set.add(item);
//     });

//     return set; // set вернет только уникальные значения
// };
